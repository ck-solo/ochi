...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen  font-['Founders_Grotesk_X'] p-20">
      <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk_X"]'>
      <div className="heading">
        <h1 className="text-[8vw]  leading-none uppercase font-semibold -mb-8">Eye-</h1>
        <h1 className="text-[8vw]  leading-none uppercase font-semibold -mb-8">Opening</h1>
        </div>
      ...
      <div className="w-1/2">
      <h1 className="text-[8vw] leading-none uppercase font-bold -mb-8">presentations
      </h1>
      <p className="text-xl font-['Neue_Montreal'] mt-8">S.</p>
        <div className="dets font-['Neue_Montreal'] mt-8 ">
            {["Instagram","Behance","Facebook","Linkedin"].map((item,index)=>{
              return <a key={index} className="block  ">{item}</a>
            })} 
        </div>
      <p className="text-sm font-['Neue_Montreal'] mt-8">L.</p>
