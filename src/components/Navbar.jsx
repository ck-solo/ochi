...
function Navbar() {
  ...
  return (
    <div
      className={`fixed z-[999] w-full px-10 py-6 font-["Neue_Montreal"] flex justify-between items-center transition-transform duration-300 ${
      ...
      <div className="links flex gap-10">
        {["Services", "Our Work", "About Us", "Insights", "Contact us"].map(
          (item, index) => (
            <a
              key={index}
              className={`text-l capitalize font-regular ${
                index === 4 && "ml-32"
              }`}
            >
              {item}
